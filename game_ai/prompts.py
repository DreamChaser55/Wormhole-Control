...
Overrides require existing turrets or positive defense strength respectively; they add no equipment
and change neither hull use, prices, build time nor upkeep. Null preserves that template preset.
