...
COMPONENT_ROWS: typing.List[typing.Dict] = [
    ...
    {"key": "has_troop_transport_component", "label": "Troop Transport", "cost_key": "troop_transport_hull_cost", "default_cost": 20.0, "is_dynamic": True},
    {"key": "has_siege_battery_component", "label": "Siege Battery", "cost_key": "siege_battery_hull_cost", "default_cost": 20.0, "is_dynamic": False},
...
COMPONENT_DESCRIPTIONS = {
    ...
    "has_troop_transport_component": "Transports invasion troops recruited at owned colonies for 2 credits and 0.2 population each. Starts empty. Requires Medium or larger hull, mobile Engines and Antimatter Storage. Invasions cost 20 AM; survivors return aboard.",
    "has_siege_battery_component": "Bombards enemy colony defenses from 1000 beyond the surface for 10 damage and 10 AM per owner turn, down to 25% readiness. Causes limited collateral losses. Requires Medium or larger hull, mobile Engines and Antimatter Storage.",
