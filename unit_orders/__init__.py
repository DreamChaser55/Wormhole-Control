...
_EXPORTS = {'OrderStatus': ('unit_orders.base', 'OrderStatus'),
 ...
 'AttackRunOrder': ('unit_orders.strikecraft', 'AttackRunOrder'),
 'EmergencyRecoveryOrder': ('unit_orders.strikecraft', 'EmergencyRecoveryOrder'),
 ...
 'RecoverFuelCacheOrder': ('unit_orders.recover_fuel', 'RecoverFuelCacheOrder'),
