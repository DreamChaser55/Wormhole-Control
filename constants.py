...
INHIBITOR_RADIUS_PER_HULL_POINT: float = 15.0
...
INHIBITION_FIELD_COLOR: tuple[int, int, int, int] = (255, 60, 60, 180)  # Semi-transparent red outline for hyperspace inhibition zones
INHIBITION_FIELD_LINE_WIDTH: int = 2  # Pixel width for hyperspace inhibition zone outline
