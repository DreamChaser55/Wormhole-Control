...
INHIBITION_FIELD_COLOR: tuple[int, int, int] = (100, 150, 255)  # Opaque light blue outline for hyperspace inhibition zones
INHIBITION_FIELD_LINE_WIDTH: int = 4  # Pixel width for hyperspace inhibition zone outline
