...
def test_dpi_bootstrap_falls_back_only_when_modern_api_is_unavailable():
    from types import SimpleNamespace
    from unittest.mock import Mock, patch
    import application_bootstrap as bootstrap
    modern, legacy = Mock(side_effect=OSError), Mock()
    ...
    with patch.object(bootstrap.os, 'name', 'nt'), patch.object(bootstrap.ctypes, 'windll', windows, create=True):
